...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_style('booncon/main.css', asset_path('styles/main.css'), false, null);
    wp_enqueue_script('booncon/main.js', asset_path('scripts/main.js'), ['jquery'], null, true);
}, 100);
...
add_action('after_setup_theme', function () {
    ...
    add_image_size( 'slider-image', 1280, 960, true );
